...
export type { CarHistory } from "./contracts/CarHistory";
export { CarHistory__factory } from "./factories/contracts/CarHistory__factory";
export type { CarRegistry } from "./contracts/CarRegistry";
export { CarRegistry__factory } from "./factories/contracts/CarRegistry__factory";
